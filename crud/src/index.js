...
//URL base para consumir API De pruebas
...
printTask(
    "Unificar las tierras que han sido batalladas por siglos...", 
    "dfajfakjdfajdf"
    );

printTask(
    "Crear una autocracia, basada en las ideas rojas, guiño, guiño...", 
    "dfañaslomcakmaoien"
    );